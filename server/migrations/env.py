...
def compile_boolean(type_, compiler, **kw):
    return 'TINYINT(1)'

# Override hành vi tạo server_default cho các trường Boolean
def process_defaults(metadata):
